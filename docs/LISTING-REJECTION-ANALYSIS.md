...
- **asset: USDT0**, **decimals = 6**. NOT USDG `0x4ae46a…` and NOT 18 decimals. The exact USDT0 X Layer address is pinned by the OKX Payment SDK / the `howtokmcp` guide during the Plan 3 spike; do not hardcode a guessed address.
