...
// The mock produces a non-empty patterns result so conformance assertions hold.
      ...
      patterns: [
        {
          ...
          chain: "ethereum",
          amplify: [{ tag: "ACTIVE_TRADER", label: "Active Trader", description: "Trades frequently" }],
          guard: [{ tag: "MULTI_CHAIN", label: "Multi Chain", description: "Uses multiple chains" }],
        },
      ],
      personas: [
        {
